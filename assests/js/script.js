...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Sneha Chauhan";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["front end development",  "Android development", "Competitive Coding"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
s1.async=true;
s1.src='https://embed.tawk.to/6107ec94d6e7610a49ae2c7b/1fc3hgni5';
s1.charset='UTF-8';
...
srtop.reveal('.home .CodeChef',{interval: 1000});
